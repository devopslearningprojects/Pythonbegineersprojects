...
if answer == "left":
    ...
    if answer == "back":
        print("You go back to the main road Now you can decide to drive home.")
    elif answer == "cross":
        answer = input(
        ...
        if answer == 'yes':
            ...
            print("You missed the oppotunity and LOSE :( ")
        else:
            print("Not a valid option. You lose.")
    else:
        print("Not a valid option. You lose. ")
...
print("Thank you for choosing Adventure game!")
